...
class DeadReckoningNode(DTROS):
    ...
    def __init__(self, node_name):
        ...
        self.sub_update = rospy.Subscriber(f'/{self.veh}/update', Pose, self.cb_update)
    ...
    def cb_update(self, data):
        ...
        angles = tr.euler_from_quaternion([data.orientation.x, data.orientation.y, data.orientation.z, data.orientation.w])
        self.yaw = angles[2]
